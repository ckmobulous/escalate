...
public class TagDetailAdapter  extends RecyclerView.Adapter<TagDetailAdapter.HomePVHolder> {
    ...
    private TagDetailAdapter.TagInterface listener;
    private HashTagHelper mHashTagHelper;

    private int playingPosition;
    private String playingPostDuration = "00:00";
    private TagDetailAdapter.HomePVHolder playingCurrentHolder;

    private TagDetailAdapter.TagDetailListener homePostPlayingListener;

    private TagDetailAct.UserTagBioListener homeBioListener;

    public TagDetailAdapter.TagDetailListener getHomePostPlayingListener() {
        return homePostPlayingListener;
    }

    public void setHomePostPlayingListener(TagDetailAdapter.TagDetailListener homePostPlayingListener) {
        this.homePostPlayingListener = homePostPlayingListener;
    }

    public TagDetailAct.UserTagBioListener getHomeBioListener() {
        return homeBioListener;
    }

    public void setHomeBioListener(TagDetailAct.UserTagBioListener homeBioListener) {
    ...
    //CONSTRUCTOR
    public TagDetailAdapter(Context context, List<TopicDetailModel.DataBean> postList) {
    ...
    @NonNull
    @Override
    public TagDetailAdapter.HomePVHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TagDetailAdapter.HomePVHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull final TagDetailAdapter.HomePVHolder holder, final int position) {
        if (postList != null) {
...
//                        updatePlayingView();
    ...
    // HELPER METHODS
    private void setProfilePic(@NonNull final TagDetailAdapter.HomePVHolder holder,
    ...
    public TagDetailAdapter.TagInterface getListener() {
        return listener;
    }

    public void setListener(TagDetailAdapter.TagInterface listener) {
     ...
     * **************************
     * */
    private void doJustCommentsPlayStopPlay(TagDetailAdapter.HomePVHolder holder, TopicDetailModel.DataBean dataBean) {
...
//        int hours = (int) ((milliseconds / (1000 * 60 * 60)) % 24);
    ...
    //        PLAY LAST RECORDING
    private void playLastRecordingComments(TagDetailAdapter.HomePVHolder holder, TopicDetailModel.DataBean dataBean) {
    ...
    private void snippetOfPlayLastRecComments(TagDetailAdapter.HomePVHolder holder,
        ...
        if (updaterThread == null) {
            if (!isBio) {
                updaterThread = new
                        ...
                        (TagDetailAct) TagDetailAdapter.this.context);
    ...
    class SiriUpdateThread implements Runnable {
        ...
        private final String TAG
                = TagDetailAdapter.SiriUpdateThread.class.getSimpleName();
        ...
        private void display_game() {
            if (this.c != null) {
                this.c.runOnUiThread(new Runnable() {
                    public void run() {
                        if (TagDetailAdapter.SiriUpdateThread.this.v != null) {
                            TagDetailAdapter.SiriUpdateThread.this.v.setMaxAmplitude(TagDetailAdapter.SiriUpdateThread.this.tr);
                        }
                    }
                });
            }
    ...
    public interface TagDetailListener {
