...
public class ProfilePostsAdapter extends RecyclerView.Adapter<ProfilePostsAdapter.ProfilePVHolder> {
    ...
    private ProfilePVHolder playingCurrentHolder;

    private ProfilePostPlayingListener profilePostPlayingListener;

    private UserProfileFragment.UserProfileBioListener profileBioListener;

    public ProfilePostPlayingListener getProfilePostPlayingListener() {
        return profilePostPlayingListener;
    }

    public void setProfilePostPlayingListener(ProfilePostPlayingListener profilePostPlayingListener) {
...
//    private Thread theWThread;
    ...
    //CONSTRUCTOR
    public ProfilePostsAdapter(Context context, List<PostListResponce.DataBean> postList) {
    ...
    @NonNull
    @Override
    public ProfilePVHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ProfilePVHolder(binding);

    }

    @Override
    public void onBindViewHolder(@NonNull final ProfilePVHolder holder, final int position) {
...
//                        updatePlayingView();
    ...
    // HELPER METHODS
    private void setProfilePic(@NonNull final ProfilePVHolder holder,
    ...
    public ProfileInterface getListener() {
        return listener;
    }

    public void setListener(ProfileInterface listener) {
        this.listener = listener;
    }


    //VIEW HOLDER CLASS
    public class ProfilePVHolder extends RecyclerView.ViewHolder implements View.OnClickListener {


        private SingleRowPostsBinding binding;

        ProfilePVHolder(SingleRowPostsBinding binding) {
            ...
            this.binding.imgOptions.setOnClickListener(this);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.img_options:
                    if (listener != null) {
                        listener.onOptionDeleteClick(v, getAdapterPosition());
                    }
                    break;
...
//                = HomeAdapter.SiriUpdateThread.class.getSimpleName();
//
//
...
//    }
     ...
     * **************************
     * */
    private void doJustCommentsPlayStopPlay(ProfilePVHolder holder, PostListResponce.DataBean dataBean) {
...
//        int hours = (int) ((milliseconds / (1000 * 60 * 60)) % 24);
    ...
    //        PLAY LAST RECORDING
    private void playLastRecordingComments(ProfilePVHolder holder, PostListResponce.DataBean dataBean) {
    ...
    private void snippetOfPlayLastRecComments(ProfilePVHolder holder, final PostListResponce.DataBean dataBean) {
    ...
    private void startSetUpSiriView(boolean isBio) {
        ...
        if (updaterThread == null) {
            if (!isBio) {
                updaterThread = new SiriUpdateThread(30, siriDView, (HomeActivity) ProfilePostsAdapter.this.context);
    ...
    public interface ProfileInterface {
        ...
        void onOptionDeleteClick(View v, int pos);

    }

    public interface ProfilePostPlayingListener {
