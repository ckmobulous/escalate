...
public class OtherProfPostsAdapter extends RecyclerView.Adapter<OtherProfPostsAdapter.OtherProfVHolder> {
    ...
    //view holder
    private OtherProfVHolder playingCurrentHolder;

    //listeners
    private OtherProfPostPlayingListener profilePostPlayingListener;
    private OtherProfileInterface listener;

    //outer class listeners
    private OtherProfileActivity.UserProfileBioListener profileBioListener;
    ...
    public OtherProfPostPlayingListener getProfilePostPlayingListener() {
        return profilePostPlayingListener;
    }

    public void setProfilePostPlayingListener(OtherProfPostPlayingListener profilePostPlayingListener) {
        this.profilePostPlayingListener = profilePostPlayingListener;
    }

    public OtherProfileActivity.UserProfileBioListener getProfileBioListener() {
        return profileBioListener;
    }

    public void setProfileBioListener(OtherProfileActivity.UserProfileBioListener profileBioListener) {
    ...
    //CONSTRUCTOR
    public OtherProfPostsAdapter(Context context, List<PostListResponce.DataBean> postList,
                                 String fromWhere) {
    ...
    @NonNull
    @Override
    public OtherProfVHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (layoutInflater == null)
            layoutInflater = LayoutInflater.from(parent.getContext());

        SingleRowPostsBinding binding =
                DataBindingUtil.inflate(layoutInflater, R.layout.single_row_posts, parent, false);


        return new OtherProfVHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull final OtherProfVHolder holder, final int position) {
        if (postList != null) {
            ...
            holder.binding.imgOptions.setVisibility(View.GONE);
...
//                updateNonPlayingView(holder);   // in onBindVH
    ...
    // HELPER METHODS
    private void setProfilePic(@NonNull final OtherProfVHolder holder,
    ...
    public void resetAllOtherPrevious() {
        try {
            ...
            if(playingCurrentHolder!=null && playingCurrentHolder.binding.imgPlayPause!=null) {
            ...
            if (profilePostPlayingListener != null)
                profilePostPlayingListener.onPostPlaying(false);
    ...
    public OtherProfileInterface getListener() {
        return listener;
    }

    public void setListener(OtherProfileInterface listener) {
    ...
    //VIEW HOLDER CLASS
    public class OtherProfVHolder extends RecyclerView.ViewHolder implements View.OnClickListener {


        private SingleRowPostsBinding binding;

        OtherProfVHolder(SingleRowPostsBinding binding) {
        ...
        public SingleRowPostsBinding getBinding() {
            return binding;
        }
     ...
     * **************************
     * */
    private void doJustCommentsPlayStopPlay(OtherProfVHolder holder, PostListResponce.DataBean dataBean)
    {
...
//        int hours = (int) ((milliseconds / (1000 * 60 * 60)) % 24);
    ...
    //        PLAY LAST RECORDING
    private void playLastRecordingComments(OtherProfVHolder holder, PostListResponce.DataBean dataBean) {
        ...
        if (profilePostPlayingListener != null)
            profilePostPlayingListener.onPostPlaying(true);
    ...
    private void snippetOfPlayLastRecComments(OtherProfVHolder holder,
                    ...
                    switch (fromWhere)
                    {
                        case "OTHER_PROFILE":
                            updaterThread = new SiriUpdateThread(30, siriDView,
                                    (OtherProfileActivity) OtherProfPostsAdapter.this.context);
                        ...
                        case "HOME_LIST":
                            updaterThread = new SiriUpdateThread(30, siriDView,
                                    (HomeActivity) OtherProfPostsAdapter.this.context);
                            updaterThread.setPRog(10000);
                            break;
    ...
    public interface OtherProfPostPlayingListener {
