...
public class FollowerAdapter extends RecyclerView.Adapter<FollowerAdapter.ViewHolder> {
    ...
    //CONSTRUCTOR
    public FollowerAdapter(Context context, List<FollowReponce.DataBean> followerList, FollowerAdapterListener followerAdapterListener) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        if (followerList != null) {
            ...
            final FollowReponce.DataBean dataBean = followerList.get(position);
            final String userid = dataBean.getUser_id();
            final String postId = dataBean.getBio();
            //AUDIO
            ...
            holder.binding.linearFollowBack.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    followerAdapterListener.followUnFollowService(position, userid);
                }
            });
...
//                updateNonPlayingView(holder);   // in onBindVH
            ...
            holder.binding.imgUser.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    followerAdapterListener.folowProfileService(position, userid);
            ...
            holder.binding.tvName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (followerAdapterListener != null) {
                        followerAdapterListener.onUserClick( position,followerList.get(position));
                    }
                }
            });
...
//        public TextView txtFullname, txtFollow;
//        public LinearLayout linearFollowBack;
...
//            linearFollowBack = itemView.findViewById(R.id.linear_follow_back);
    ...
    public interface FollowerAdapterListener {
        ...
        void folowProfileService(int position, String audioid);
