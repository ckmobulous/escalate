...
public abstract class SingleRowPostsBinding extends ViewDataBinding {
  @NonNull
  ...
  protected SingleRowPostsBinding(DataBindingComponent _bindingComponent, View _root,
      int _localFieldCount, SeekBar SeekBar01, CardView cardView, LinearLayout eventLl,
      ImageView imgComment, ImageView imgHeart, ImageView imgOptions, ImageView imgPlayPause,
      ImageView imgReply, ImageView imgShare, RoundedImageView imgUser,
      ...
      TextView tvCategoryHash, TextView tvName, TextView txtDescription, TextView txtLike,
      TextView txtReplies, TextView txtTimer) {
  ...
  @NonNull
  public static SingleRowPostsBinding inflate(@NonNull LayoutInflater inflater,
  ...
  public static SingleRowPostsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<SingleRowPostsBinding>inflate(inflater, com.escalate.R.layout.single_row_posts, root, attachToRoot, component);
  }
  ...
  public static SingleRowPostsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<SingleRowPostsBinding>inflate(inflater, com.escalate.R.layout.single_row_posts, null, false, component);
  }

  public static SingleRowPostsBinding bind(@NonNull View view) {
    return bind(view, DataBindingUtil.getDefaultComponent());
  }

  public static SingleRowPostsBinding bind(@NonNull View view,
      @Nullable DataBindingComponent component) {
    return (SingleRowPostsBinding)bind(component, view, com.escalate.R.layout.single_row_posts);
  }
}
