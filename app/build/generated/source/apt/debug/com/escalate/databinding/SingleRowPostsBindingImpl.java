...
public class SingleRowPostsBindingImpl extends SingleRowPostsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.img_comment, 19);
        sViewsWithIds.put(R.id.imgShare, 20);
        sViewsWithIds.put(R.id.img_reply, 21);
        sViewsWithIds.put(R.id.txt_like, 22);
    ...
    public SingleRowPostsBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 24, sIncludes, sViewsWithIds));
    }
    private SingleRowPostsBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
